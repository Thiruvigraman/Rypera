...
def init_db():
    try:
        ...
        log_to_discord(None, "MongoDB connected successfully.", log_type='status')
        return db, movies_collection, users_collection, sent_files_collection
    except Exception as e:
        log_to_discord(None, f"Failed to connect to MongoDB: {e}", log_type='status')
        raise e

# Initialize DB
db, movies_collection, users_collection, sent_files_collection = init_db()
